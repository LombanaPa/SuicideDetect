...
class Modeltrain:
    ...
    def buil_model(self):
        ...
        model_nn = Sequential([
            ...
            Dense(500, activation='relu', kernel_regularizer='l1'),
        ...
        model_nn.compile(optimizer=keras.optimizers.Adam(self.learning_rate), loss=keras.losses.BinaryCrossentropy(),
                         metrics=['accuracy'])
    ...
    def train_model(self):
        ...
        #model_nn.save("src/app/results/model_bert.h5")
